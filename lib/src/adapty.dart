...
class Adapty {
  ...
  static final StreamController<String> _deferredPurchasesController =
      StreamController.broadcast();
  static final StreamController<GetPaywallsResult>
      _getPaywallsResultController = StreamController.broadcast();
  static final StreamController<AdaptyPurchaserInfo>
      _purchaserInfoUpdateController = StreamController.broadcast();
  static final StreamController<AdaptyPromo> _promosReceiveController =
      StreamController.broadcast();
  ...
  static Future<bool> updateProfile(
      AdaptyProfileParameterBuilder builder) async {
    final result =
        await _invokeMethodHandlingErrors<bool>(Method.updateProfile, {
  ...
  static Future<bool> updateAttribution(Map attribution,
      {required AdaptyAttributionNetwork source, String? networkUserId}) async {
    final result =
        await _invokeMethodHandlingErrors<bool>(Method.updateAttribution, {
  ...
  static AdaptyVisualPaywallPurchaseSuccessResult?
      _onVisualPaywallPurchaseSuccess;
  ...
  static Future<bool> showVisualPaywall({
    ...
    final result =
        await _invokeMethodHandlingErrors<bool>(Method.showVisualPaywall, {
              Argument.variationId: paywall.variationId,
            }) ??
            false;
    if (result) {
  ...
  static Future<bool> closeVisualPaywall() async {
    final result =
        await _invokeMethodHandlingErrors<bool>(Method.closeVisualPaywall);
  ...
  static Future<dynamic> _handleIncomingMethodCall(MethodCall call) {
    switch (call.method) {
      ...
      case Method.visualPaywallPurchaseSuccessResult:
        var result = call.arguments as String;
        _onVisualPaywallPurchaseSuccess
            ?.call(MakePurchaseResult.fromJson(json.decode(result)));
        return Future.value(null);
      ...
      case Method.visualPaywallRestoreResult:
        var result = call.arguments as String;
        _onVisualPaywallRestored
            ?.call(RestorePurchasesResult.fromJson(json.decode(result)));
        return Future.value(null);
      default:
        return Future.value(null);
    }
