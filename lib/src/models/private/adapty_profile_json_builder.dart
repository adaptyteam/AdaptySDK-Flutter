...
extension AdaptyProfileJSONBuilder on AdaptyProfile {
  static AdaptyProfile fromJsonValue(Map<String, dynamic> json) {
    return AdaptyProfile._(
      ...
      json
              .stringListIfPresent(_Keys.appliedExternalAttributionProviders)
              ?.map((value) => AdaptyExternalAttributionProvider(value))
              .toList(growable: false) ??
          const <AdaptyExternalAttributionProvider>[],
...
class _Keys {
  ...
  static const appliedExternalAttributionProviders = 'applied_attribution_sources';
