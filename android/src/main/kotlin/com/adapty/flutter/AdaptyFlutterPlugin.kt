...
class AdaptyFlutterPlugin : FlutterPlugin, ActivityAware, MethodCallHandler {
    ...
    companion object {
        ...
        fun registerWith(registrar: PluginRegistry.Registrar) {
            ...
            instance.crossplatformHelper.activity = registrar.activity()
    ...
    private fun onAttachedToEngine(context: Context, binaryMessenger: BinaryMessenger) {
        ...
        CrossplatformHelper.init(
            ...
            { assetId -> FileLocation.fromAsset(getLookupKeyForAsset(assetId)) },
        )
    }

    private fun onNewActivityPluginBinding(binding: ActivityPluginBinding?) {
        crossplatformHelper.activity = binding?.activity
    }
}
